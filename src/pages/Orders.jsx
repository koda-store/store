...
function Orders() {
    ...
    return (
        ...
        <>
            <div className="bg-slate-100 min-h-[80vh] overflow-scroll"> 
                <div className="mx-auto max-w-4xl space-y-4">
                    <h2>Orders</h2>
                    <h3 className="font-bold text-3xl text-slate-800 py-2">My Orders</h3>
                    {myOrders.map((order) => (
                            ...
                            <div className="bg-white border border-slate-200 rounded rounded-lg flex justify-between p-4 mb-2 mx-1
                             hover:shadow-lg">
                                <div className="flex  flex-col justify-evenly">
                                    <div>
                                        <span className="text-slate-800  font-semibold  pr-3">#{order._id.slice(-6)}</span>
                                ...
                                <div className="text-lg font-bold text-indigo-600 py-6">

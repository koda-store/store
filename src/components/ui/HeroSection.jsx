        ...
        <div className='container py-2.5 flex flex-col'>
            <div className='max-w-3xl'>
                ...
                <div className='flex items-center justify-start max-sm:justify-center gap-2.5 mt-5'>
                    <button onClick={() => navigate('/shop')} className='shadow-md rounded-md cursor-pointer max-sm:px-3 max-sm:py-2 mt-3 max-sm:text-sm font-semibold bg-white text-purple-700 inline-flex px-5 py-2.5 border border-white hover:bg-gray-100 transition-all duration-150'>Shop Now</button>
